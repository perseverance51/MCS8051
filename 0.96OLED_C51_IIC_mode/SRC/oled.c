...
{ 	
	...
	OLED_WR_Byte(0xFF,OLED_CMD);//--设置SEG输出电流亮度128   
	OLED_WR_Byte(0xA1,OLED_CMD);// 设置分段/列映射0xa0左右反置 0xa1正常
	OLED_WR_Byte(0xA6,OLED_CMD);//--normal / reverse 反向
	OLED_WR_Byte(0xA8,OLED_CMD);//--设置复用比(1 to 64)
