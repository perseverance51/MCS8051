...
void	PCA_config(void)
{
	...
	PCA_Init(PCA_Counter,&PCA_InitStructure);	//定时器时钟源选择
	...
	PCA_InitStructure.PCA_Value    = 128 << 8;			//对PWM输出占空比50%，
	PCA_Init(PCA0,&PCA_InitStructure); //PWM输出
	...
	PCA_Init(PCA1,&PCA_InitStructure);	//捕获模式
	...
	PCA_Init(PCA2,&PCA_InitStructure);	//高速脉冲输出
