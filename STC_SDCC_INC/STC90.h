...
sfr  P1_ADC_EN  =   0x97;       //P1口模拟功能控制位    Bit7    Bit6    Bit5    Bit4    Bit3    Bit2    Bit1    Bit0
                                //位描述                ADC_P17 ADC_P16 ADC_P15 ADC_P14 ADC_P13 ADC_P12 ADC_P11 ADC_P10
                                //初始值=0000,0000      0       0       0       0       0       0       0       0

#define ADC_P17     0x80        //P1.7口为ADC输入脚
#define ADC_P16     0x40        //P1.7口为ADC输入脚
#define ADC_P15     0x20        //P1.7口为ADC输入脚
#define ADC_P14     0x10        //P1.7口为ADC输入脚
#define ADC_P13     0x08        //P1.7口为ADC输入脚
#define ADC_P12     0x04        //P1.7口为ADC输入脚
#define ADC_P11     0x02        //P1.7口为ADC输入脚
#define ADC_P10     0x01        //P1.7口为ADC输入脚
...
sfr  ADC_CONTR  =   0xc5;       //ADC控制寄存器         Bit7    Bit6    Bit5    Bit4    Bit3    Bit2    Bit1    Bit0
                                //位描述                -       SPEED1 SPEED0 ADC_FLAG ADC_START CHS2   CHS1    CHS0
                                //初始值=xxx0,0000      x       x       x       0       0       0       0       0

#define ADC_SPEEDHH 0x00        //每次转换需要89个时钟周期
#define ADC_SPEEDH  0x20        //每次转换需要178个时钟周期
#define ADC_SPEEDL  0x40        //每次转换需要356个时钟周期
#define ADC_SPEEDLL 0x60        //每次转换需要534个时钟周期
...
sfr  ADC_LOW2   =   0xc7;       //ADC结果低字节         Bit7    Bit6    Bit5    Bit4    Bit3    Bit2    Bit1    Bit0
                                //初始值=xxxx,xx00      x       x       x       x       x       x       0       0
